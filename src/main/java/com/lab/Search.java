...
public class Search extends HttpServlet {
       ...
       public void doGet(HttpServletRequest request, HttpServletResponse response)
              ...
              try{
                     ...
                     Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/register","root","manager");               
                     PreparedStatement ps=con.prepareStatement("select * from akshayganjiwar_111915009_detail where id=?");
                     PreparedStatement ps1=con.prepareStatement("select * from akshayganjiwar_111915009_salary where id=?");
                     ps.setString(1,id);     
                     ps1.setString(1,id);          
